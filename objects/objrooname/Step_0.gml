/// @description 
 // TODO: CHECK IF check_pressed WORKS WITH JOYSTICK
...
key_shift = keyboard_check_pressed(vk_shift)  or gamepad_button_check(4, gp_face1);
key_space = keyboard_check_pressed(vk_space)  or gamepad_button_check(4, gp_face2);
